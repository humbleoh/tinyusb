...
//R8_UHOST_CTRL
 #define UHOST_SEND_BUS_RESET          (1<<0)
 #define UHOST_SEND_BUS_SUSPEND        (1<<1)
 #define UHOST_SEND_BUS_RESUME         (1<<2)
 #define UHOST_REMOTE_WAKE             (1<<3)
 #define UHOST_PHY_SUSPENDM            (1<<4)
 #define UHOST_UH_SOFT_FREE            (1<<6)
 #define UHOST_SEND_SOF_EN             (1<<7)
